...
import com.bw.movie.view.ByKeywordActivity;
 ...
 * @class describe
 */
public class Atcivity_Key_Adapter extends RecyclerView.Adapter {
    private List<KeyWorkBean.ResultBean> list;
    private Context context;
    private onItemId onItemId;

    public Atcivity_Key_Adapter(List<KeyWorkBean.ResultBean> list, Context context) {
        this.list = list;
    ...
    public void setOnItemId(Atcivity_Key_Adapter.onItemId onItemId) {
