 ...
 * @class describe
 */
public class Nearby_Fragment extends BaseFragment<Fragment_Presenter> implements Contract.IView {
    ...
    protected void initView(View view) {
        recycler_near = view.findViewById(R.id.recycler_near);
    }

    @Override
    protected void initData() {
        mPresenter.onNearby(userId, sessionId, null, null, 1, 5);
    }
    ...
    public void onSuccess(Object obj) {
        ...
        Fragment_RecommendAdapter nearAdapter = new Fragment_RecommendAdapter(result, getContext());
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(getContext());
        linearLayoutManager.setOrientation(LinearLayoutManager.VERTICAL);
        recycler_near.setLayoutManager(linearLayoutManager);
        recycler_near.setAdapter(nearAdapter);
    }
