 ...
 * @class describe
 */
public class Fragment_ByDateAdapter extends RecyclerView.Adapter {
    private List<ByDateBean.ResultBean> list;
    private Context context;
    private onItemId onItemId;


    public Fragment_ByDateAdapter(List<ByDateBean.ResultBean> result, Context context) {
        this.list = result;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_bydate, parent, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (onItemId != null) {
                    onItemId.onItemID(list.get(position).getCinemaId());
                }
            }
        });
    }
    ...
    public void setOnItemId(Fragment_ByDateAdapter.onItemId onItemId) {
