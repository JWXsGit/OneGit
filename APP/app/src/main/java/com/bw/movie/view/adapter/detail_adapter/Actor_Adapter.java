 ...
 * <p>更改时间：2019/10/19<p>
 */
public class Actor_Adapter extends RecyclerView.Adapter {
    private List<DetailBean.ResultBean.MovieActorBean> list;
    private Context context;

    public Actor_Adapter(List<DetailBean.ResultBean.MovieActorBean> list, Context context) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int position) {
        ...
        holder.director_item_name.setText(list.get(position).getName().trim());
        holder.item_name_replace.setText("饰" + list.get(position).getRole().trim());
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView director_item_name, item_name_replace;
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            item_name_replace = itemView.findViewById(R.id.item_name_replace);
        }
    }
}
