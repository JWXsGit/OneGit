...
import com.bw.movie.view.fragment.myfragment.Cinema_review_Fragment;
import com.bw.movie.view.fragment.myfragment.Movie_review_Fragment;
...
public class CommentActivity extends BaseActivity<MyPresenter> implements Contract.IView {
    ...
    protected void initData() {
        ...
        fraglist.add(new Movie_review_Fragment());
        fraglist.add(new Cinema_review_Fragment());
